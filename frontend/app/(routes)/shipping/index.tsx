...
export default function ShippingAddressScreen() {
  ...
  const getAddressTypeColor = (label: Address["label"]) => {
    switch (label.toLowerCase()) {
      case "home":
  ...
  const openDeleteModal = (address: Address) => {
    if (addresses.length === 1) {
      toast.error("Cannot delete the last address. Please add another address");
      return;
    }
  ...
  const renderAddressCard = (address: Address) => {
    ...
    return (
      <View
        key={address.id}
        className="bg-white rounded-2xl shadow-[0_0_1px_rgba(0,0,0,0.1)] mb-4"
      >
          ...
          <ScrollView className="flex-1 p-4" showsVerticalScrollIndicator={false}>
            {showModal === "delete" ? (
              <View className="flex-1 justify-center items-center py-20">
                ...
                <Text className="text-gray-600 font-poppins-medium text-center mb-4 mt-2">
                ...
                <View className="w-full gap-3">
                  <TouchableOpacity
                    ...
                    onPress={() => selectedAddress && handleDeleteAddress(selectedAddress.id)}
                  >
                  ...
                  <TouchableOpacity className="bg-gray-100 py-4 rounded-xl" onPress={closeModal}>
              ...
              <View className="gap-4">
                      ...
                      >
                        <Text
                          className={`font-poppins-medium text-center ${
                            formData.label === label ? "text-blue-600" : "text-gray-700"
                          }`}
                        >
                          {label}
                        </Text>
                ...
                <View className="flex-row items-center justify-between py-3">
                    ...
                    onPress={() => {
                      if (
                        ...
                        if (
                          ...
                          toast.error(
                            "Cannot remove default status from the only default address"
                          );
                          return;
                        }
                      }
                  ...
                  >
                    <View
                      className={`w-[22px] h-[22px] bg-white rounded-full shadow-sm transform ${
  ...
  const renderMainContent = () => {
    ...
    return <>{addresses.map(renderAddressCard)}</>;
  };
    ...
    <SafeAreaView edges={["bottom"]} className="flex-1 pt-12 bg-gray-50">
      ...
      <View className="bg-white px-4 py-4 border-b border-gray-100">
        <View className="flex-row items-center justify-between">
          ...
          <TouchableOpacity className="bg-blue-600 px-4 py-2 rounded-lg" onPress={openAddModal}>
            <View className="flex-row items-center">
